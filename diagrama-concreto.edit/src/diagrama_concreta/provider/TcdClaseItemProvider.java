	...
	protected void addModificadorAccesoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TcdClase_modificadorAcceso_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TcdClase_modificadorAcceso_feature", "_UI_TcdClase_type"),
				 Diagrama_concretaPackage.Literals.TCD_CLASE__MODIFICADOR_ACCESO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
