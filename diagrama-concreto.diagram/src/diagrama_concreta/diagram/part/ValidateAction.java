...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(diagrama_concreta.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		diagrama_concreta.diagram.providers.Diagrama_concretaValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			diagrama_concreta.diagram.providers.Diagrama_concretaMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		diagrama_concreta.diagram.providers.Diagrama_concretaMarkerNavigationProvider.addMarker(target, elementId,
