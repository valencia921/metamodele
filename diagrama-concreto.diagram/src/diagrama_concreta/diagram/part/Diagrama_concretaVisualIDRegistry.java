...
public class Diagrama_concretaVisualIDRegistry {
	...
	* @generated
	*/
	private static final String DEBUG_KEY = "diagrama-concreto.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.checkNodeVisualID(containerView,
