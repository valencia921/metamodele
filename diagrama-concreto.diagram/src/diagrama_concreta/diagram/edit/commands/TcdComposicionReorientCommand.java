 ...
 * @generated
 */
public class TCDComposicionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TCDComposicionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof diagrama_concreta.TCDComposicion) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTCDComposicion_4002(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		diagrama_concreta.TCDDiagramaClases container = (diagrama_concreta.TCDDiagramaClases) getLink().eContainer();
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTCDComposicion_4002(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected diagrama_concreta.TCDComposicion getLink() {
		return (diagrama_concreta.TCDComposicion) getElementToEdit();
	}
