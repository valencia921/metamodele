 ...
 * @generated
 */
public class TCDDependenciaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TCDDependenciaReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof diagrama_concreta.TCDDependencia) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTCDDependencia_4003(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		diagrama_concreta.TCDDiagramaClases container = (diagrama_concreta.TCDDiagramaClases) getLink().eContainer();
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTCDDependencia_4003(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected diagrama_concreta.TCDDependencia getLink() {
		return (diagrama_concreta.TCDDependencia) getElementToEdit();
	}
