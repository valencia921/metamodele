 ...
 * @generated
 */
public class TCDHerenciaCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TCDHerenciaCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTCDHerencia_4004(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		diagrama_concreta.TCDHerencia newElement = diagrama_concreta.Diagrama_concretaFactory.eINSTANCE
				.createTCDHerencia();
	...
	* @generated
	*/
	protected void doConfigure(diagrama_concreta.TCDHerencia newElement, IProgressMonitor monitor, IAdaptable info)
