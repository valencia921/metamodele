 ...
 * @generated
 */
public class TCDAsociacionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TCDAsociacionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTCDAsociacion_4001(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		diagrama_concreta.TCDAsociacion newElement = diagrama_concreta.Diagrama_concretaFactory.eINSTANCE
				.createTCDAsociacion();
	...
	* @generated
	*/
	protected void doConfigure(diagrama_concreta.TCDAsociacion newElement, IProgressMonitor monitor, IAdaptable info)
