 ...
 * @generated
 */
public class TCDAgregacionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TCDAgregacionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return diagrama_concreta.diagram.edit.policies.Diagrama_concretaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTCDAgregacion_4005(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		diagrama_concreta.TCDAgregacion newElement = diagrama_concreta.Diagrama_concretaFactory.eINSTANCE
				.createTCDAgregacion();
	...
	* @generated
	*/
	protected void doConfigure(diagrama_concreta.TCDAgregacion newElement, IProgressMonitor monitor, IAdaptable info)
