 ...
 * @generated
 */
public class Diagrama_concretaBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected Diagrama_concretaBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = diagrama_concreta.diagram.providers.Diagrama_concretaElementTypes
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
