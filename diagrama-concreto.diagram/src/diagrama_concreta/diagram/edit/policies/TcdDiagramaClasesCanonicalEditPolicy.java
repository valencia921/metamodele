...
public class TCDDiagramaClasesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<diagrama_concreta.diagram.part.Diagrama_concretaNodeDescriptor> descriptorsIterator = childDescriptors
	...
	*/
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<diagrama_concreta.diagram.part.Diagrama_concretaLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
			...
			for (Iterator<diagrama_concreta.diagram.part.Diagrama_concretaLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				diagrama_concreta.diagram.part.Diagrama_concretaLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	...
	*/
	private Collection<IAdaptable> createConnections(
			Collection<diagrama_concreta.diagram.part.Diagrama_concretaLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
	...
	*/
	protected final EditPart getHintedEditPart(EObject domainModelElement, Domain2Notation domain2NotationMap,
		...
		View view = (View) domain2NotationMap.getHinted(domainModelElement,
				diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry().get(view);
		}
		return null;
