 ...
 * @generated
 */
public class TCDDependenciaNombreOrigenNombreDestiEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
						diagrama_concreta.diagram.edit.parts.TCDDependenciaNombreOrigenNombreDestiEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TCDDependenciaNombreOrigenNombreDestiEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new diagrama_concreta.diagram.edit.policies.Diagrama_concretaTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = diagrama_concreta.diagram.providers.Diagrama_concretaParserProvider.getParser(
					...
					getParserElement(), diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
							diagrama_concreta.diagram.edit.parts.TCDDependenciaNombreOrigenNombreDestiEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					diagrama_concreta.diagram.edit.parts.Diagrama_concretaEditPartFactory
	...
	*/
	protected IFigure createFigurePrim() {
		return new TCDDependenciaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TCDDependenciaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TCDDependenciaLabelFigure() {
			this.setText("TCDDependencia");
		}
