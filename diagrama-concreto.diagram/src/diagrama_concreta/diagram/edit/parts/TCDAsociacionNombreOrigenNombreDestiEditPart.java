 ...
 * @generated
 */
public class TCDAsociacionNombreOrigenNombreDestiEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
						diagrama_concreta.diagram.edit.parts.TCDAsociacionNombreOrigenNombreDestiEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TCDAsociacionNombreOrigenNombreDestiEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TCDAsociacionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TCDAsociacionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TCDAsociacionLabelFigure() {
			this.setText("TCDAsociacion");
		}
