 ...
 * @generated
 */
public class TCDAgregacionNombreOrigenNombreDestiEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
						diagrama_concreta.diagram.edit.parts.TCDAgregacionNombreOrigenNombreDestiEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TCDAgregacionNombreOrigenNombreDestiEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TCDAgregacionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TCDAgregacionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TCDAgregacionLabelFigure() {
			this.setText("TCDAgregacion");
		}
