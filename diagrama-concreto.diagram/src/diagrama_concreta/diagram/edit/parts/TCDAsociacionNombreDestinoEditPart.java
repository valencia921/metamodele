 ...
 * @generated
 */
public class TCDAsociacionNombreDestinoEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TCDAsociacionNombreDestinoEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = diagrama_concreta.diagram.providers.Diagrama_concretaParserProvider.getParser(
					...
					getParserElement(), diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
							diagrama_concreta.diagram.edit.parts.TCDAsociacionNombreDestinoEditPart.VISUAL_ID));
		}
		return parser;
	}
