 ...
 * @generated
 */
public class TCDMetodoNombreTipoRetornoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TCDMetodoNombreTipoRetornoEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return diagrama_concreta.diagram.providers.Diagrama_concretaElementTypes.getImage(parserElement.eClass());
	}
		...
		if (parser == null) {
			parser = diagrama_concreta.diagram.providers.Diagrama_concretaParserProvider.getParser(
					...
					getParserElement(), diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
							diagrama_concreta.diagram.edit.parts.TCDMetodoNombreTipoRetornoEditPart.VISUAL_ID));
		}
		return parser;
	}
