 ...
 * @generated
 */
public class TCDMetodoTipoRetornoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TCDMetodoTipoRetornoEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = diagrama_concreta.diagram.providers.Diagrama_concretaParserProvider.getParser(
					...
					getParserElement(), diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
							.getType(diagrama_concreta.diagram.edit.parts.TCDMetodoTipoRetornoEditPart.VISUAL_ID));
		}
		return parser;
	}
