 ...
 * @generated
 */
public class TCDComposicionNombreOrigenNombreDestiEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getType(
						diagrama_concreta.diagram.edit.parts.TCDComposicionNombreOrigenNombreDestiEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TCDComposicionNombreOrigenNombreDestiEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TCDComposicionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TCDComposicionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TCDComposicionLabelFigure() {
			this.setText("TCDComposicion");
		}
