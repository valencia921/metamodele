 ...
 * 
 */
package diagrama_concreta.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(diagrama_concreta.diagram.part.Messages.MessageFormatParser_InvalidInputError,
