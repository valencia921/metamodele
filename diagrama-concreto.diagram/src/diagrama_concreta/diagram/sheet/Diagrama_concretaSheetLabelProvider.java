 ...
 * @generated
 */
public class Diagrama_concretaSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	*/
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			...
			IElementType etype = diagrama_concreta.diagram.providers.Diagrama_concretaElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
