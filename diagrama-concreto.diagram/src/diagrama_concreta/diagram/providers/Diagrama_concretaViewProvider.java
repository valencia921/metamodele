 ...
 * @generated
 */
public class Diagrama_concretaViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				if (!diagrama_concreta.diagram.providers.Diagrama_concretaElementTypes.isKnownElementType(elementType)
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
	...
	*/
	public Edge createTCDAgregacion_4005(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6001 = createLabel(edge, diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
				.getType(diagrama_concreta.diagram.edit.parts.TCDAgregacionNombreDestinoMultipliciEditPart.VISUAL_ID));
	...
	*/
	public Edge createTCDAsociacion_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6002 = createLabel(edge, diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
				.getType(diagrama_concreta.diagram.edit.parts.TCDAsociacionNombreDestinoMultipliciEditPart.VISUAL_ID));
	...
	*/
	public Edge createTCDComposicion_4002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6003 = createLabel(edge, diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
				.getType(diagrama_concreta.diagram.edit.parts.TCDComposicionNombreDestinoMultipliciEditPart.VISUAL_ID));
	...
	*/
	public Edge createTCDDependencia_4003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6004 = createLabel(edge, diagrama_concreta.diagram.part.Diagrama_concretaVisualIDRegistry
				.getType(diagrama_concreta.diagram.edit.parts.TCDDependenciaNombreDestinoMultipliciEditPart.VISUAL_ID));
