 ...
 * @generated
 */
public class Diagrama_concretaMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorUtil.selectElementsInDiagram(editor,
