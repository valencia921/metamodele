 ...
 * @generated
 */
public class Diagrama_concretaShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorPlugin.getInstance()
