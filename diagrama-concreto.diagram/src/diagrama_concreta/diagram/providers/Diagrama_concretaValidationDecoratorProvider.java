 ...
 * @generated
 */
public class Diagrama_concretaValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof diagrama_concreta.diagram.part.Diagrama_concretaDiagramEditor) {
