 ...
 * @generated
 */
public class Diagrama_concretaDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public Diagrama_concretaDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof diagrama_concreta.diagram.navigator.Diagrama_concretaDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((diagrama_concreta.diagram.navigator.Diagrama_concretaDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new diagrama_concreta.diagram.navigator.Diagrama_concretaDomainNavigatorItem(
