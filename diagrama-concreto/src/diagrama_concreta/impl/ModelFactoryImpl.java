 ...
 * </p>
 * <ul>
 *   <li>{@link diagrama_concreta.impl.ModelFactoryImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link diagrama_concreta.impl.ModelFactoryImpl#getRuta <em>Ruta</em>}</li>
 *   <li>{@link diagrama_concreta.impl.ModelFactoryImpl#getListaDiagramas <em>Lista Diagramas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelFactoryImpl extends EObjectImpl implements ModelFactory {
	...
	protected EClass eStaticClass() {
		return Diagrama_concretaPackage.Literals.MODEL_FACTORY;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.MODEL_FACTORY__NOMBRE, oldNombre, nombre));
	}
	...
	public void setRuta(String newRuta) {
		...
		ruta = newRuta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.MODEL_FACTORY__RUTA, oldRuta, ruta));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Diagrama_concretaPackage.MODEL_FACTORY__NOMBRE:
				return getNombre();
			case Diagrama_concretaPackage.MODEL_FACTORY__RUTA:
				return getRuta();
			case Diagrama_concretaPackage.MODEL_FACTORY__LISTA_DIAGRAMAS:
