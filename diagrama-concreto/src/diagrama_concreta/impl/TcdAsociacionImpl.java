...
public class TCDAsociacionImpl extends TCDRelacionImpl implements TCDAsociacion {
	...
	protected EClass eStaticClass() {
		return Diagrama_concretaPackage.Literals.TCD_ASOCIACION;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_ASOCIACION__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_ASOCIACION__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_ASOCIACION__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_ASOCIACION__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
