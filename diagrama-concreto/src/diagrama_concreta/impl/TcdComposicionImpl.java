...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TCD Composicion</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link diagrama_concreta.impl.TCDComposicionImpl#getNombreOrigen <em>Nombre Origen</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDComposicionImpl#getNombreDestino <em>Nombre Destino</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDComposicionImpl#getMultiplicidadOrigen <em>Multiplicidad Origen</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDComposicionImpl#getMultiplicidadDestino <em>Multiplicidad Destino</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDComposicionImpl#getNavegavilidad <em>Navegavilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCDComposicionImpl extends TCDRelacionImpl implements TCDComposicion {
	/**
	...
	protected EClass eStaticClass() {
		return Diagrama_concretaPackage.Literals.TCD_COMPOSICION;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_COMPOSICION__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_COMPOSICION__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_COMPOSICION__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_COMPOSICION__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
	...
	public void setNavegavilidad(Navegavilidad newNavegavilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_COMPOSICION__NAVEGAVILIDAD, oldNavegavilidad, navegavilidad));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Diagrama_concretaPackage.TCD_COMPOSICION__NOMBRE_ORIGEN:
				return getNombreOrigen();
			case Diagrama_concretaPackage.TCD_COMPOSICION__NOMBRE_DESTINO:
				return getNombreDestino();
			case Diagrama_concretaPackage.TCD_COMPOSICION__MULTIPLICIDAD_ORIGEN:
				return getMultiplicidadOrigen();
			case Diagrama_concretaPackage.TCD_COMPOSICION__MULTIPLICIDAD_DESTINO:
				return getMultiplicidadDestino();
			case Diagrama_concretaPackage.TCD_COMPOSICION__NAVEGAVILIDAD:
