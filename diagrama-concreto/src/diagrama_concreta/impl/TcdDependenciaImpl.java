 ...
 * </p>
 * <ul>
 *   <li>{@link diagrama_concreta.impl.TCDDependenciaImpl#getNombreOrigen <em>Nombre Origen</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDDependenciaImpl#getNombreDestino <em>Nombre Destino</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDDependenciaImpl#getMultiplicidadOrigen <em>Multiplicidad Origen</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDDependenciaImpl#getMultiplicidadDestino <em>Multiplicidad Destino</em>}</li>
 *   <li>{@link diagrama_concreta.impl.TCDDependenciaImpl#getNavegavilidad <em>Navegavilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCDDependenciaImpl extends TCDRelacionImpl implements TCDDependencia {
	...
	protected EClass eStaticClass() {
		return Diagrama_concretaPackage.Literals.TCD_DEPENDENCIA;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_DEPENDENCIA__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_DEPENDENCIA__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
	...
	public void setNavegavilidad(Navegavilidad newNavegavilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Diagrama_concretaPackage.TCD_DEPENDENCIA__NAVEGAVILIDAD, oldNavegavilidad, navegavilidad));
	}
