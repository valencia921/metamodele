...
/**
 * This is the item provider adapter for a {@link abstracta_relacional.PrimaryKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryKey_columna_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKey_columna_feature", "_UI_PrimaryKey_type"),
				 Abstracta_relacionalPackage.Literals.PRIMARY_KEY__COLUMNA,
				 true,
				 false,
				 true,
				 null,
