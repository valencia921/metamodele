...
/**
 * This is the item provider adapter for a {@link abstracta_relacional.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMomentTypePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Abstracta_relacionalPackage.Literals.TRIGGER__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Moment Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMomentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_momentType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_momentType_feature", "_UI_Trigger_type"),
				 Abstracta_relacionalPackage.Literals.TRIGGER__MOMENT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addActionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_actionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_actionType_feature", "_UI_Trigger_type"),
				 Abstracta_relacionalPackage.Literals.TRIGGER__ACTION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
