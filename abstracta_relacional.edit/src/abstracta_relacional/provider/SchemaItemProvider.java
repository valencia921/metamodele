...
/**
 * This is the item provider adapter for a {@link abstracta_relacional.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Abstracta_relacionalPackage.Literals.SCHEMA__NAME,
				 true,
				 false,
				 false,
	...
	protected void addUserPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schema_user_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schema_user_feature", "_UI_Schema_type"),
				 Abstracta_relacionalPackage.Literals.SCHEMA__USER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPasswordPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schema_password_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schema_password_feature", "_UI_Schema_type"),
				 Abstracta_relacionalPackage.Literals.SCHEMA__PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Abstracta_relacionalPackage.Literals.SCHEMA__LIST_TABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Abstracta_relacionalPackage.Literals.SCHEMA__LIST_TABLES,
				 Abstracta_relacionalFactory.eINSTANCE.createTable()));
	}
