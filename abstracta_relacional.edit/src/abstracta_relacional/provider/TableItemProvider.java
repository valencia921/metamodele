...
/**
 * This is the item provider adapter for a {@link abstracta_relacional.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Abstracta_relacionalPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Abstracta_relacionalPackage.Literals.TABLE__PRIMARY_KEY);
			childrenFeatures.add(Abstracta_relacionalPackage.Literals.TABLE__LIST_RELATIONS);
			childrenFeatures.add(Abstracta_relacionalPackage.Literals.TABLE__LIST_COLUMNS);
			childrenFeatures.add(Abstracta_relacionalPackage.Literals.TABLE__LIST_TRIGGERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Abstracta_relacionalPackage.Literals.TABLE__PRIMARY_KEY,
				 Abstracta_relacionalFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(Abstracta_relacionalPackage.Literals.TABLE__LIST_RELATIONS,
				 Abstracta_relacionalFactory.eINSTANCE.createRelation()));

		newChildDescriptors.add
			(createChildParameter
				(Abstracta_relacionalPackage.Literals.TABLE__LIST_COLUMNS,
				 Abstracta_relacionalFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(Abstracta_relacionalPackage.Literals.TABLE__LIST_TRIGGERS,
				 Abstracta_relacionalFactory.eINSTANCE.createTrigger()));
	}
