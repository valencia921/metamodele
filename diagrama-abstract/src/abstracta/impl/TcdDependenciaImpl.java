 ...
 *   <li>{@link abstracta.impl.TCDDependenciaImpl#getNavegavilidad <em>Navegavilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCDDependenciaImpl extends TCDRelacionImpl implements TCDDependencia {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.TCD_DEPENDENCIA;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_DEPENDENCIA__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_DEPENDENCIA__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
	...
	public void setNavegavilidad(Navegavilidad newNavegavilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_DEPENDENCIA__NAVEGAVILIDAD, oldNavegavilidad, navegavilidad));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractaPackage.TCD_DEPENDENCIA__NOMBRE_ORIGEN:
				return getNombreOrigen();
			case AbstractaPackage.TCD_DEPENDENCIA__NOMBRE_DESTINO:
				return getNombreDestino();
			case AbstractaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_ORIGEN:
				return getMultiplicidadOrigen();
			case AbstractaPackage.TCD_DEPENDENCIA__MULTIPLICIDAD_DESTINO:
				return getMultiplicidadDestino();
			case AbstractaPackage.TCD_DEPENDENCIA__NAVEGAVILIDAD:
