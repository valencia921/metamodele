 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.TCDComposicionImpl#getNombreOrigen <em>Nombre Origen</em>}</li>
 *   <li>{@link abstracta.impl.TCDComposicionImpl#getNombreDestino <em>Nombre Destino</em>}</li>
 *   <li>{@link abstracta.impl.TCDComposicionImpl#getMultiplicidadOrigen <em>Multiplicidad Origen</em>}</li>
 *   <li>{@link abstracta.impl.TCDComposicionImpl#getMultiplicidadDestino <em>Multiplicidad Destino</em>}</li>
 *   <li>{@link abstracta.impl.TCDComposicionImpl#getNavegavilidad <em>Navegavilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCDComposicionImpl extends TCDRelacionImpl implements TCDComposicion {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.TCD_COMPOSICION;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_COMPOSICION__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_COMPOSICION__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_COMPOSICION__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_COMPOSICION__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
	...
	public void setNavegavilidad(Navegavilidad newNavegavilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_COMPOSICION__NAVEGAVILIDAD, oldNavegavilidad, navegavilidad));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AbstractaPackage.TCD_COMPOSICION__NAVEGAVILIDAD:
