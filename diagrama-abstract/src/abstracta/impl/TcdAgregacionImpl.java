 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.TCDAgregacionImpl#getNombreOrigen <em>Nombre Origen</em>}</li>
 *   <li>{@link abstracta.impl.TCDAgregacionImpl#getNombreDestino <em>Nombre Destino</em>}</li>
 *   <li>{@link abstracta.impl.TCDAgregacionImpl#getMultiplicidadOrigen <em>Multiplicidad Origen</em>}</li>
 *   <li>{@link abstracta.impl.TCDAgregacionImpl#getMultiplicidadDestino <em>Multiplicidad Destino</em>}</li>
 *   <li>{@link abstracta.impl.TCDAgregacionImpl#getNavegavilidad <em>Navegavilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCDAgregacionImpl extends TCDRelacionImpl implements TCDAgregacion {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.TCD_AGREGACION;
	}
	...
	public void setNombreOrigen(String newNombreOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_AGREGACION__NOMBRE_ORIGEN, oldNombreOrigen, nombreOrigen));
	}
	...
	public void setNombreDestino(String newNombreDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_AGREGACION__NOMBRE_DESTINO, oldNombreDestino, nombreDestino));
	}
	...
	public void setMultiplicidadOrigen(Multiplicidad newMultiplicidadOrigen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_AGREGACION__MULTIPLICIDAD_ORIGEN, oldMultiplicidadOrigen, multiplicidadOrigen));
	}
	...
	public void setMultiplicidadDestino(Multiplicidad newMultiplicidadDestino) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_AGREGACION__MULTIPLICIDAD_DESTINO, oldMultiplicidadDestino, multiplicidadDestino));
	}
	...
	public void setNavegavilidad(Navegavilidad newNavegavilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.TCD_AGREGACION__NAVEGAVILIDAD, oldNavegavilidad, navegavilidad));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AbstractaPackage.TCD_AGREGACION__NAVEGAVILIDAD:
